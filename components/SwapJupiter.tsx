...
export default function SwapJupiterRedirect() {
  ...
  }, [sellMint, buyMint, amount, slippageBps]);
  ...
  return (
    <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-5">
      ...
      <a
        ...
        className="mt-4 inline-block w-full text-center bg-black text-white border border-neon-green shadow-[0_0_15px_#00ff00] hover:shadow-[0_0_20px_#39ff14] rounded-md px-4 py-2 font-bold"
      >
        Swap on Jupiter
      </a>

      <p className="mt-3 text-xs text-zinc-400">
        You will be redirected to Jupiter to complete the swap.
      </p>
    </section>
  );
}
